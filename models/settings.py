...
class Settings(models.Model):
    ...
    saltapi_url = fields.Char(default='',string='Salt API URL')
    ...
    saltapi_passwd = fields.Char(required=True, string='Salt API Password',
                                 default='odoo')
    #: Debug mode
    debug_mode = fields.Boolean(default=True)
    ...
    delete_recordings = fields.Boolean(
        default=False,
        help='Delete recordings on Asterisk after upload to Odoo.')
    ...
    def test_ping(self):
        ...
        server.local_job(fun='test.ping', res_notify_uid=self.env.user.id)
